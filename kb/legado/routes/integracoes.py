...
@integracoes_bp.route('/integracoes')
def admin_integracoes():
    ...
    try:
        ...
        return render_template('integracoes.html', accounts=accounts)
    except Exception as e:
        print(f"Erro na rota de integrações: {e}")
        return render_template('error.html', error=str(e)), 500

@integracoes_bp.route('/api/integracoes/status/<account_id>')
...
@integracoes_bp.route('/integracoes/<account_id>/edit', methods=['GET', 'POST'])
def edit_integration(account_id):
    ...
    if not account:
        ...
        return redirect(url_for('integracoes.admin_integracoes'))
...
@integracoes_bp.route('/integracoes/<account_id>/delete', methods=['POST'])
...
@integracoes_bp.route('/integracoes/new', methods=['GET', 'POST'])
def new_integration():
