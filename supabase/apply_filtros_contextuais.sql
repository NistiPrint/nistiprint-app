...
-- ============================================
-- Versão corrigida - 2026-03-31
-- Corrige: horario_coleta não estava sendo retornado
-- ============================================

-- Drop das funções existentes
DROP FUNCTION IF EXISTS "public"."fn_canais_proximos_coleta"(integer);
DROP FUNCTION IF EXISTS "public"."fn_contar_pedidos_por_canal"(integer, integer, boolean);
DROP VIEW IF EXISTS "public"."v_canais_coleta_dia";
...
'Conta pedidos por canal de venda. Usa tabela pivot demandas_pedidos.';
...
-- TESTE RÁPIDO
-- ============================================================================
-- SELECT * FROM fn_canais_proximos_coleta(2);
-- SELECT * FROM fn_contar_pedidos_por_canal(NULL, 7, NULL);
