-- Migration: Adicionar filtro de data do pedido na list_pedidos_filtrados
-- Data: 2026-04-24
--
-- Objetivo: Permitir filtrar pedidos por período de data do pedido (data_venda)
...
-- Criar função com parâmetros de data do pedido
...
'Retorna lista de pedidos com filtros avançados (incluindo data do pedido), ordenada por numero_pedido.';
