-- Expose operational marketplace timestamps in the order listing RPC.
...
'Retorna pedidos com filtros avancados, origem canonica e timestamps operacionais de compra, pagamento, coleta e envio.';
