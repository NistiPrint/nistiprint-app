...
export default function DemandaRascunhosPage() {
        ...
        <div className="flex justify-between items-start mb-8">
          <div>
            <div className="flex items-center gap-2 mb-2">
              <h1 className="text-3xl font-bold tracking-tight">Rascunhos de Demandas</h1>
          ...
          <div className="flex gap-2">
            ...
            <Tooltip>
              ...
              <TooltipContent>Ir para todas as demandas</TooltipContent>
            </Tooltip>
          </div>
        </div>
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-gray-500 text-center max-w-md">
                {filtro === 'todos'
                  ? 'Os rascunhos automáticos aparecerão aqui quando pedidos forem recebidos via webhook ou quando você usar "Forçar Consolidação".'
                  : `Não há rascunhos ${filtro} no momento.`}
              </p>
              {filtro === 'todos' && (
                <Button className="mt-4" onClick={handleForcarConsolidacao}>
                  <Zap className="h-4 w-4 mr-2" />
                  Forçar Consolidação Agora
                </Button>
              )}
            </CardContent>
          </Card>
